...
def test_avg_stats_by_type_correct():
    ...
    # charmander y charmeleon son fire puros; charizard es fire/flying
    expected_hp = round((39 + 58 + 78) / 3, 2)
...
def test_avg_stats_by_type_dual_pokemon():
    ...
    # venusaur es grass/poison → ambos tipos deben aparecer
    assert "grass" in tipos
    assert "poison" in tipos
